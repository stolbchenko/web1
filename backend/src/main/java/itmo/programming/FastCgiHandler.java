...
/**
 * Обработчик одного HTTP-запроса (через FastCGI).
 */
public final class FastCgiHandler {
     ...
     * @param env переменные окружения FastCGI (содержат QUERY_STRING и др.)
    ...
    /** Разбор query string в Map<String,String>. */
    ...
    /** Отправка ошибки JSON с нужным кодом. */
