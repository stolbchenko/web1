...
(function () {
    ...
    /** Приведение полей результата к строкам/примитивам для стабильного хранения */
    ...
    /**
     * Мерджим с серверной историей. По умолчанию сервер — источник истины.
     * Если хочешь объединять — можно склеить и отсортировать по времени.
     */
